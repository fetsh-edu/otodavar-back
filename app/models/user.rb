class User < ApplicationRecord
  ...
  def open_games = games.order(updated_at: :desc).open.includes(:player_2, :player_1)
  def closed_games = games.order(updated_at: :desc).closed.includes(:player_1, :player_2).limit(20)
